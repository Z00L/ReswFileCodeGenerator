...
namespace ReswCodeGen
{
	...
	public sealed class VisualStudio2015Package : Package
	{
		...
		{
			Debug.WriteLine(string.Format("Entering constructor of: {0}", nameof(VisualStudio2015Package)));
		}
		...
		{
			Debug.WriteLine(string.Format("Entering Initialize() of: {0}", nameof(VisualStudio2015Package)));
			base.Initialize();
		}
	}
}