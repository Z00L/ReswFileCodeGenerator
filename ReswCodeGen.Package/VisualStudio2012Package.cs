...
namespace ReswCodeGen
{
	...
	public sealed class VisualStudio2012Package : Package
	{
		...
		{
			Debug.WriteLine(string.Format("Entering constructor of: {0}", nameof(VisualStudio2012Package)));
		}
		...
		{
			Debug.WriteLine(string.Format("Entering Initialize() of: {0}", nameof(VisualStudio2012Package)));
			base.Initialize();
		}
	}
}