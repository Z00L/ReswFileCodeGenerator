...
namespace ReswCodeGen
{
	...
	public sealed class VisualStudio2013Package : Package
	{
		...
		{
			Debug.WriteLine(string.Format("Entering constructor of: {0}", nameof(VisualStudio2013Package)));
		}
		...
		{
			Debug.WriteLine(string.Format("Entering Initialize() of: {0}", nameof(VisualStudio2013Package)));
			base.Initialize();
		}
	}
}